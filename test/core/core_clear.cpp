...
namespace clear {
  ...
  int test_texture(typename texture::extent_type Size, const gli::format& Format, const std::vector<genType>& Colors) {
    int Error = 0;
  ...
  int test() {
    ...
    std::vector<glm::vec4> ColorRGBA32F = {
      ...
      glm::vec4(1.0, 0.5, 0, 1.0),
      glm::vec4(1.0, 1.0, 0, 1.0),
      glm::vec4(0, 1.0, 0, 1.0),
      glm::vec4(0, 1.0, 1.0, 1.0),
      glm::vec4(0, 0, 1.0, 1.0),
      glm::vec4(1.0, 0, 1.0, 1.0)
    };
    ...
    for (std::size_t i = 0; i < Sizes.size(); ++i) {
      // TODO: below test fails - investigate or remove!
      // Error += test_texture<gli::texture1d>(gli::texture1d::dim_type(Sizes[i]), gli::FORMAT_RGB_DXT1_UNORM_BLOCK8,
      //				    ColorDXT1);
      Error += test_texture<gli::texture2d>(gli::texture2d::extent_type(Sizes[i]), gli::FORMAT_RGB_DXT1_UNORM_BLOCK8,
                                            ColorDXT1);
      Error += test_texture<gli::texture3d>(gli::texture3d::extent_type(Sizes[i]), gli::FORMAT_RGB_DXT1_UNORM_BLOCK8,
                                            ColorDXT1);
      Error += test_texture<gli::texture1d>(gli::texture1d::extent_type(Sizes[i]), gli::FORMAT_R8_UNORM_PACK8,
                                            ColorR8_UNORM);
      Error += test_texture<gli::texture2d>(gli::texture2d::extent_type(Sizes[i]), gli::FORMAT_R8_UNORM_PACK8,
                                            ColorR8_UNORM);
      Error += test_texture<gli::texture3d>(gli::texture3d::extent_type(Sizes[i]), gli::FORMAT_R8_UNORM_PACK8,
                                            ColorR8_UNORM);
      Error += test_texture<gli::texture1d>(gli::texture1d::extent_type(Sizes[i]), gli::FORMAT_RGB8_UNORM_PACK8,
                                            ColorRGB8_UNORM);
      Error += test_texture<gli::texture2d>(gli::texture2d::extent_type(Sizes[i]), gli::FORMAT_RGB8_UNORM_PACK8,
                                            ColorRGB8_UNORM);
      Error += test_texture<gli::texture3d>(gli::texture3d::extent_type(Sizes[i]), gli::FORMAT_RGB8_UNORM_PACK8,
                                            ColorRGB8_UNORM);
      Error += test_texture<gli::texture1d>(gli::texture1d::extent_type(Sizes[i]), gli::FORMAT_RGBA8_UNORM_PACK8,
                                            ColorRGBA8_UNORM);
      Error += test_texture<gli::texture2d>(gli::texture2d::extent_type(Sizes[i]), gli::FORMAT_RGBA8_UNORM_PACK8,
                                            ColorRGBA8_UNORM);
      Error += test_texture<gli::texture3d>(gli::texture3d::extent_type(Sizes[i]), gli::FORMAT_RGBA8_UNORM_PACK8,
                                            ColorRGBA8_UNORM);
      Error += test_texture<gli::texture1d>(gli::texture1d::extent_type(Sizes[i]), gli::FORMAT_RGBA32_SFLOAT_PACK32,
                                            ColorRGBA32F);
      Error += test_texture<gli::texture2d>(gli::texture2d::extent_type(Sizes[i]), gli::FORMAT_RGBA32_SFLOAT_PACK32,
                                            ColorRGBA32F);
      Error += test_texture<gli::texture3d>(gli::texture3d::extent_type(Sizes[i]), gli::FORMAT_RGBA32_SFLOAT_PACK32,
                                            ColorRGBA32F);
    }
