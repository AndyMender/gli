...
namespace {
  std::string path(const std::string& filename, char const* ext) {
...
int main() {
  ...
  std::vector<params> Params {
    params("array_r8_uint", gli::FORMAT_R8_UINT_PACK8),
    params("kueken7_rgba8_unorm", gli::FORMAT_RGBA8_UNORM_PACK8),
    params("kueken7_rgba8_srgb", gli::FORMAT_RGBA8_SRGB_PACK8),
    params("kueken7_bgra8_unorm", gli::FORMAT_BGRA8_UNORM_PACK8),
    params("kueken7_bgra8_srgb", gli::FORMAT_BGRA8_SRGB_PACK8),
    params("kueken7_r5g6b5_unorm", gli::FORMAT_B5G6R5_UNORM_PACK16),
    params("kueken7_rgba4_unorm", gli::FORMAT_BGRA4_UNORM_PACK16),
    params("kueken7_rgb5a1_unorm", gli::FORMAT_BGR5A1_UNORM_PACK16),
    params("kueken8_rgba8_srgb", gli::FORMAT_RGBA8_SRGB_PACK8),
    params("kueken7_rgba_dxt5_unorm", gli::FORMAT_RGBA_DXT5_UNORM_BLOCK16)
  };
...

  {
    for (auto& param_item : Params) {
      Error += load_file_ktx::test(param_item);
      Error += load_file_kmg::test(param_item);
      Error += load_file_dds::test(param_item);
    }
  }
