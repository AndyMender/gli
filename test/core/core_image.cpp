...
int test_image_ctor() {
  ...
  const gli::image ImageA(gli::FORMAT_RGBA8_UINT_PACK8, gli::image::extent_type(4, 4, 1));
  const gli::image ImageB(gli::FORMAT_RGBA8_UINT_PACK8, gli::image::extent_type(4, 4, 1));
  const gli::image ImageC = ImageA;
  const gli::image ImageD(ImageA, gli::FORMAT_RGBA8_UNORM_PACK8);
  const gli::image ImageE(ImageD, gli::FORMAT_RGBA8_UNORM_PACK8);
