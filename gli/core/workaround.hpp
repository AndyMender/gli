...
// TODO: then remove this header and its docs in ./doc/api/?
namespace gli {
  namespace workaround {
    namespace detail {
      ...
      template <typename T, typename floatType, precision P, template <typename, precision> class vecType,
                bool isInteger, bool signedType>
      ...
      struct compute_half<P, tvec2> {
        GLM_FUNC_QUALIFIER static tvec2<uint16, P> pack(tvec2<float, P> const &v) {
          ...
          return tvec2<uint16, P>(reinterpret_cast<uint16 const &>(Unpacked.x),
                                  reinterpret_cast<uint16 const &>(Unpacked.y));
        }

        GLM_FUNC_QUALIFIER static tvec2<float, P> unpack(tvec2<uint16, P> const &v) {
          return tvec2<float, P>(glm::detail::toFloat32(reinterpret_cast<int16 const &>(v.x)),
      ...
      struct compute_half<P, tvec3> {
        GLM_FUNC_QUALIFIER static tvec3<uint16, P> pack(tvec3<float, P> const &v) {
          tvec3<int16, P> const Unpacked(glm::detail::toFloat16(v.x), glm::detail::toFloat16(v.y),
                                         glm::detail::toFloat16(v.z));
          return tvec3<uint16, P>(reinterpret_cast<uint16 const &>(Unpacked.x),
                                  reinterpret_cast<uint16 const &>(Unpacked.y),
                                  reinterpret_cast<uint16 const &>(Unpacked.z));
        }

        GLM_FUNC_QUALIFIER static tvec3<float, P> unpack(tvec3<uint16, P> const &v) {
          return tvec3<float, P>(glm::detail::toFloat32(reinterpret_cast<int16 const &>(v.x)),
                                 glm::detail::toFloat32(reinterpret_cast<int16 const &>(v.y)),
      ...
      struct compute_half<P, tvec4> {
        GLM_FUNC_QUALIFIER static vec<4, uint16, P> pack(vec<4, float, P> const &v) {
          vec<4, int16, P> const Unpacked(glm::detail::toFloat16(v.x), glm::detail::toFloat16(v.y),
                                          glm::detail::toFloat16(v.z), glm::detail::toFloat16(v.w));
          return vec<4, uint16, P>(
              reinterpret_cast<uint16 const &>(Unpacked.x), reinterpret_cast<uint16 const &>(Unpacked.y),
              reinterpret_cast<uint16 const &>(Unpacked.z), reinterpret_cast<uint16 const &>(Unpacked.w));
        }

        GLM_FUNC_QUALIFIER static vec<4, float, P> unpack(vec<4, uint16, P> const &v) {
          return vec<4, float, P>(glm::detail::toFloat32(reinterpret_cast<int16 const &>(v.x)),
                                  glm::detail::toFloat32(reinterpret_cast<int16 const &>(v.y)),
                                  glm::detail::toFloat32(reinterpret_cast<int16 const &>(v.z)),
