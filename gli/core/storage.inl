// TODO: this header is no longer used - remove?
#include "../index.hpp"
...
namespace gli {
  ...
  inline storage_linear::storage_linear(format_type Format, extent_type const& Extent, size_type Layers,
  ...
  inline storage_linear::extent_type storage_linear::block_count(size_type Level) const {
    ...
    return glm::max(
        this->BlockCount >> storage_linear::extent_type(static_cast<storage_linear::extent_type::value_type>(Level)),
  ...
  inline void storage_linear::copy(storage_linear const& StorageSrc, size_t LayerSrc, size_t FaceSrc, size_t LevelSrc,
                                   extent_type const& BlockIndexSrc, size_t LayerDst, size_t FaceDst, size_t LevelDst,
                                   extent_type const& BlockIndexDst, extent_type const& BlockCount) {
    ...
    for (size_t BlockIndexZ = 0, BlockCountZ = BlockCount.z; BlockIndexZ < BlockCountZ; ++BlockIndexZ)
      for (size_t BlockIndexY = 0, BlockCountY = BlockCount.y; BlockIndexY < BlockCountY; ++BlockIndexY) {
        ...
        gli::size_t const OffsetSrc =
            linear_index(BlockIndexSrc + BlockIndex, this->extent(LevelSrc)) * this->block_size();
        gli::size_t const OffsetDst =
            linear_index(BlockIndexDst + BlockIndex, this->extent(LevelDst)) * this->block_size();
