// TODO: this looks like a copy of storage_linear.hpp - cross-include?
#pragma once
...
namespace gli {
  class storage_linear {
   ...
   public:
    ...
    storage_linear(format_type Format, extent_type const& Extent, size_type Layers, size_type Faces, size_type Levels);
    ...
    void copy(storage_linear const& StorageSrc, size_t LayerSrc, size_t FaceSrc, size_t LevelSrc,
