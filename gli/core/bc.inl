...
namespace gli {
  namespace detail {
    ...
    inline texel_block4x4 decompress_bc1_block(const bc1_block& Block) { return decompress_dxt1_block(Block); }
    ...
    inline texel_block4x4 decompress_bc2_block(const bc2_block& Block) { return decompress_dxt3_block(Block); }
    ...
    inline texel_block4x4 decompress_bc3_block(const bc3_block& Block) { return decompress_dxt5_block(Block); }

    // TODO: use references instead of raw pointers?
    ...
    // TODO: use references instead of raw pointers?
    inline void single_channel_bitmap_data_unorm(uint8_t Channel0, uint8_t Channel1, const uint8_t* ChannelBitmap,
                                                 float* LookupTable, uint64_t& ContiguousBitmap) {
    ...
    inline void single_channel_bitmap_data_snorm(uint8_t Channel0, uint8_t Channel1, const uint8_t* ChannelBitmap,
                                                 float* LookupTable, uint64_t& ContiguousBitmap) {
    ...
    inline void single_channel_bitmap_data_snorm(uint8_t Channel0, uint32_t Channel1, bool Interpolate6,
                                                 const uint8_t* ChannelBitmap, float* LookupTable,
    ...
    inline texel_block4x4 decompress_bc5snorm_block(const bc5_block& Block) {
      ...
      single_channel_bitmap_data_snorm(Block.Green0, Block.Green1, Block.Red0 > Block.Red1, Block.GreenBitmap, GreenLUT,
                                       GreenBitmap);
