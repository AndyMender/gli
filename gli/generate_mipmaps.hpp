...
namespace gli {
  ...
  texture_type generate_mipmaps(const texture_type& Texture, filter Minification);

  /// Allocate a texture and generate the mipmaps of the texture from the BaseLevel to the MaxLevel included using the
  /// Minification filter.
  texture1d generate_mipmaps(const texture1d& Texture,
			     texture1d::size_type BaseLevel,
			     texture1d::size_type MaxLevel,
                             filter Minification);

  /// Allocate a texture and generate the mipmaps of the texture from the BaseLayer to the MaxLayer and from the
  /// BaseLevel to the MaxLevel included levels using the Minification filter.
  texture1d_array generate_mipmaps(const texture1d_array& Texture,
  ...
  /// Allocate a texture and generate the mipmaps of the texture from the BaseLevel to the MaxLevel included using the
  /// Minification filter.
  texture2d generate_mipmaps(const texture2d& Texture,
  ...
  /// Allocate a texture and generate the mipmaps of the texture from the BaseLayer to the MaxLayer and from the
  /// BaseLevel to the MaxLevel included levels using the Minification filter.
  texture2d_array generate_mipmaps(const texture2d_array& Texture,
  ...
  /// Allocate a texture and generate the mipmaps of the texture from the BaseLevel to the MaxLevel included using the
  /// Minification filter.
  texture3d generate_mipmaps(const texture3d& Texture,
			     texture3d::size_type BaseLevel,
			     texture3d::size_type MaxLevel,
                             filter Minification);

  /// Allocate a texture and generate the mipmaps of the texture from the BaseLayer to the MaxLayer, from the BaseFace
  /// to the MaxFace and from the BaseLevel to the MaxLevel included levels using the Minification filter.
  texture_cube generate_mipmaps(const texture_cube& Texture,
  ...
  /// Allocate a texture and generate the mipmaps of the texture from the BaseLayer to the MaxLayer and from the
  /// BaseLevel to the MaxLevel included levels using the Minification filter.
  texture_cube_array generate_mipmaps(const texture_cube_array& Texture,
