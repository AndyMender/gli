...
namespace gli {
  ...
  inline sampler3d<T, P>::sampler3d(const texture_type& Texture, wrap Wrap, filter Mip, filter Min,
      ...
      : sampler(Wrap, Texture.levels() > 1 ? Mip : FILTER_NEAREST, Min),
        ...
        Filter(detail::get_filter<filter_type, detail::DIMENSION_3D, texture_type, interpolate_type, normalized_type,
  ...
  template <typename T, qualifier P>
  inline const typename sampler3d<T, P>::texture_type& sampler3d<T, P>::operator()() const {
    return this->Texture;
  }

  template <typename T, qualifier P>
  inline typename sampler3d<T, P>::texel_type sampler3d<T, P>::texel_fetch(const extent_type& TexelCoord,
  ...
  template <typename T, qualifier P>
  inline void sampler3d<T, P>::texel_write(const extent_type& TexelCoord, const size_type& Level,
  ...
  template <typename T, qualifier P>
  inline void sampler3d<T, P>::clear(const texel_type& Color) {
    GLI_ASSERT(!this->Texture.empty());
    GLI_ASSERT(this->Convert.Write);
  ...
  template <typename T, qualifier P>
  GLI_FORCE_INLINE typename sampler3d<T, P>::texel_type sampler3d<T, P>::texture_lod(const normalized_type& SampleCoord,
