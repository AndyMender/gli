...
namespace gli {
  constexpr std::uint32_t gli_makefourcc(const char ch0, const char ch1, const char ch2, const char ch3) {
    return static_cast<std::uint32_t>((((std::uint32_t)(std::uint8_t)(ch3) << 24) & 0xFF000000) |
  ...
  class dx {
   public:
    // TODO: move enums to enum classes and out of 'dx' class?
    enum d3dfmt {
      D3DFMT_UNKNOWN = 0,
