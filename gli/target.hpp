...
namespace gli {
  ...
  inline bool is_target_1d(target Target) { return Target == TARGET_1D || Target == TARGET_1D_ARRAY; }
  ...
  inline bool is_target_cube(target Target) { return Target == TARGET_CUBE || Target == TARGET_CUBE_ARRAY; }

  /// Check whether a target is a rectangle target
  inline bool is_target_rect(target Target) { return Target == TARGET_RECT || Target == TARGET_RECT_ARRAY; }
}  // namespace gli
