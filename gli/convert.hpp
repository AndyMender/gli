/// @brief Include to copy textures, images or a subset of either textures or an images. These operations will cause
/// memory allocations.
...
namespace gli {
  ...
  texture_type convert(const texture_type& Texture, format Format);
}  // namespace gli
